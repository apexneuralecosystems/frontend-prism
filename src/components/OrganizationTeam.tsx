...
import {
    ...
    UserPlus, UserMinus, Save, LogOut, Menu, UserCircle, Briefcase, FileText
} from 'lucide-react';
...
export function OrganizationTeam() {
    ...
    const [addTeamHovered, setAddTeamHovered] = useState(false);
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                            <button
                                ...
                                style={{ 
                                    ...
                                    fontSize: '14px',
                                    color: '#ffffff',
                                    background: addTeamHovered ? '#1d4ed8' : '#2563eb',
                                    border: 'none',
                                    cursor: 'pointer',
